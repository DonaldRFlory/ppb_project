...
//the following part is generated by ldfutil.exe----------------------------------------
		...
		public U32 DSetPWMVal(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			return (U32)SetPWMVal((U8)Par1, (U16)Par2);
		}

		public U32 DSetPWMFreq(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			return (U32)SetPWMFreq((U8)Par1, (U16)Par2);
		}

		public U32 DLoadServoUsec(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			LoadServoUsec((U8)Par1, (U16)Par2);
			return 0;
		}
		...
		public void InitMenuDelegates()
		{
			...
			AddMenuDelegate("SetPWMVal", new MenuDelegate(DSetPWMVal));
			AddMenuDelegate("SetPWMFreq", new MenuDelegate(DSetPWMFreq));
			AddMenuDelegate("LoadServoUsec", new MenuDelegate(DLoadServoUsec));
