...
namespace TestApp
{
	 ...
	 public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            ADVals[0] = ADVals[0] = ADVals[0] = ADVals[0] = 0;
...
//            }
  ...
  //          tbServ0Pos.Text = trbServ0.Value.ToString();
        ...
        private void tbarServ0_ValueChanged(object sender, EventArgs e)
        {
            tbServ0Pos.Text = tbarServ0.Value.ToString();
        ...
        private void tbarServ1_ValueChanged(object sender, EventArgs e)
        {
            tbServ1Pos.Text = tbarServ1.Value.ToString();
            LocSetServoUsec((U8)1, (U16)tbarServ1.Value);
        }

        private void tbarServ1_Scroll(object sender, EventArgs e)
        {
            LocSetServoUsec((U8)1, (U16)tbarServ1.Value);
        }

        private void tbarServ2_ValueChanged(object sender, EventArgs e)
        {
            tbServ2Pos.Text = tbarServ2.Value.ToString();
            LocSetServoUsec((U8)2, (U16)tbarServ2.Value);
        }

        private void tbarServ2_Scroll(object sender, EventArgs e)
        {
            LocSetServoUsec((U8)2, (U16)tbarServ2.Value);
        }

        private void tbarServ3_ValueChanged(object sender, EventArgs e)
        {
            tbServ3Pos.Text = tbarServ3.Value.ToString();
            LocSetServoUsec((U8)3, (U16)tbarServ3.Value);
        }

        private void tbarServ3_Scroll(object sender, EventArgs e)
        {
            LocSetServoUsec((U8)3, (U16)tbarServ3.Value);
        }

        private void nudServ0Min_ValueChanged(object sender, EventArgs e)
        {
            tbarServ0.Minimum = (int)nudServ0Min.Value;
        }

        private void nudServ0Max_ValueChanged(object sender, EventArgs e)
        {
            tbarServ0.Maximum = (int)nudServ0Max.Value;
        }

        private void nudServ1Max_ValueChanged(object sender, EventArgs e)
        {
            tbarServ1.Maximum = (int)nudServ1Max.Value;
        }

        private void nudServ1Min_ValueChanged(object sender, EventArgs e)
        {
            tbarServ1.Minimum = (int)nudServ1Min.Value;
        }

        private void nudServ2Max_ValueChanged(object sender, EventArgs e)
        {
            tbarServ2.Maximum = (int)nudServ2Max.Value;
        }

        private void nudServ2Min_ValueChanged(object sender, EventArgs e)
        {
            tbarServ2.Minimum = (int)nudServ2Min.Value;
        }

        private void nudServ3Max_ValueChanged(object sender, EventArgs e)
        {
            tbarServ3.Maximum = (int)nudServ3Max.Value;
        }

        private void nudServ3Min_ValueChanged(object sender, EventArgs e)
        {
            tbarServ3.Minimum = (int)nudServ3Min.Value;
        }
