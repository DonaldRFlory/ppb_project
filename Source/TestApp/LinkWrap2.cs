...
//End Lead-in code file LWPart1.CS ---------------------------
		...
		private SetSlaveParameter(U8 ParCode, U16 Param1, U16 Param2)
		{
			LINK.SetSlaveParameter(CMgr.CurHandle(), ParCode, Param1, Param2);
		}
		...
		static class LINK
		{
			...
			[DllImport(@".\1343API.dll")]
			public static extern U32 GetSlaveParameter(API_DEVICE_HANDLE Handle, ref U32 RtnVal, U8 ParCode, U8 Index);
			[DllImport(@".\1343API.dll")]
			public static extern U8 SetSlaveParameter(API_DEVICE_HANDLE Handle, ref U32 RtnVal, U8 ParCode, U16 Param1, U16 Param2);
		}
	}
}
