/****************************************************************************
 *   $Id:: i2c.c 4329 2010-08-18 17:49:09Z usb00423                         $
 *   Project: NXP LPC11Axx I2C example
 *
 *   Description:
...
uint32_t I2CInit( uint32_t I2cMode ) 
{
  ...
  LPC_IOCON->PIO0_2 |= (0x1<<10);	/* open drain pins */
  LPC_IOCON->PIO0_3 |= (0x1<<10);	/* open drain pins */
#endif
#if 0
