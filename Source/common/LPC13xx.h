...
{
  union {
  __I  uint32_t  U0RBR;                   /*!< Offset: 0x000 (R/ )  Receiver Buffer  Register */
  __O  uint32_t  U0THR;                   /*!< Offset: 0x000 ( /W)  Transmit Holding Register */
  __IO uint32_t  U0DLL;                   /*!< Offset: 0x000 (R/W)  Divisor Latch LSB */
  };
  union {
  __IO uint32_t  U0DLM;                   /*!< Offset: 0x004 (R/W)  Divisor Latch MSB */
  __IO uint32_t  U0IER;                   /*!< Offset: 0x000 (R/W)  Interrupt Enable Register */
  };
  union {
  __I  uint32_t  U0IIR;                   /*!< Offset: 0x008 (R/ )  Interrupt ID Register */
  __O  uint32_t  U0FCR;                   /*!< Offset: 0x008 ( /W)  FIFO Control Register */
  };
  __IO uint32_t  U0LCR;                   /*!< Offset: 0x00C (R/W)  Line Control Register */
  __IO uint32_t  U0MCR;                   /*!< Offset: 0x010 (R/W)  Modem control Register */
  __I  uint32_t  U0LSR;                   /*!< Offset: 0x014 (R/ )  Line Status Register */
  __I  uint32_t  U0MSR;                   /*!< Offset: 0x018 (R/ )  Modem status Register */
  __IO uint32_t  U0SCR;                   /*!< Offset: 0x01C (R/W)  Scratch Pad Register */
  __IO uint32_t  U0ACR;                   /*!< Offset: 0x020 (R/W)  Auto-baud Control Register */
       uint32_t  U0RESERVED0[1];
  __IO uint32_t  U0FDR;                   /*!< Offset: 0x028 (R/W)  Fractional Divider Register */
       uint32_t  U0RESERVED1[1];
  __IO uint32_t  U0TER;                   /*!< Offset: 0x030 (R/W)  Transmit Enable Register */
       uint32_t  U0RESERVED2[6];
  __IO uint32_t  U0RS485CTRL;             /*!< Offset: 0x04C (R/W)  RS-485/EIA-485 Control Register */
  __IO uint32_t  U0ADRMATCH;              /*!< Offset: 0x050 (R/W)  RS-485/EIA-485 address match Register */
  __IO uint32_t  U0RS485DLY;              /*!< Offset: 0x054 (R/W)  RS-485/EIA-485 direction control delay Register */
...
typedef struct
{
  __IO uint32_t SSP0CR0;                    /*!< Offset: 0x000 (R/W)  Control Register 0 */
  __IO uint32_t SSP0CR1;                    /*!< Offset: 0x004 (R/W)  Control Register 1 */
  __IO uint32_t SSP0DR;                     /*!< Offset: 0x008 (R/W)  Data Register */
  __I  uint32_t SSP0SR;                     /*!< Offset: 0x00C (R/ )  Status Register */
  __IO uint32_t SSP0CPSR;                   /*!< Offset: 0x010 (R/W)  Clock Prescale Register */
  __IO uint32_t SSP0IMSC;                   /*!< Offset: 0x014 (R/W)  Interrupt Mask Set and Clear Register */
  __I  uint32_t SSP0RIS;                    /*!< Offset: 0x018 (R/ )  Raw Interrupt Status Register */
  __I  uint32_t SSP0MIS;                    /*!< Offset: 0x01C (R/ )  Masked Interrupt Status Register */
  __O  uint32_t SSP0ICR;                    /*!< Offset: 0x020 ( /W)  SSPICR Interrupt Clear Register */
} LPC_SSP_TypeDef;
...
typedef struct
{
  __IO uint32_t I2C0CONSET;             	/*!< Offset: 0x000 (R/W)  I2C Control Set Register */
  __I  uint32_t I2C0STAT;                   /*!< Offset: 0x004 (R/ )  I2C Status Register */
  __IO uint32_t I2C0DAT;                    /*!< Offset: 0x008 (R/W)  I2C Data Register */
  __IO uint32_t I2C0ADR0;                   /*!< Offset: 0x00C (R/W)  I2C Slave Address Register 0 */
  __IO uint32_t I2C0SCLH;                   /*!< Offset: 0x010 (R/W)  SCH Duty Cycle Register High Half Word */
  __IO uint32_t I2C0SCLL;                   /*!< Offset: 0x014 (R/W)  SCL Duty Cycle Register Low Half Word */
  __O  uint32_t I2C0CONCLR;             	/*!< Offset: 0x018 ( /W)  I2C Control Clear Register */
  __IO uint32_t I2C0MMCTRL;                 /*!< Offset: 0x01C (R/W)  Monitor mode control register */
  __IO uint32_t I2C0ADR1;                   /*!< Offset: 0x020 (R/W)  I2C Slave Address Register 1 */
  __IO uint32_t I2C0ADR2;                   /*!< Offset: 0x024 (R/W)  I2C Slave Address Register 2 */
  __IO uint32_t I2C0ADR3;                   /*!< Offset: 0x028 (R/W)  I2C Slave Address Register 3 */
  __I  uint32_t I2C0DATA_BUFFER;            /*!< Offset: 0x02C (R/ )  Data buffer Register */
  __IO uint32_t I2C0MASK0;                  /*!< Offset: 0x030 (R/W)  I2C Slave address mask register 0 */
  __IO uint32_t I2C0MASK1;                  /*!< Offset: 0x034 (R/W)  I2C Slave address mask register 1 */
  __IO uint32_t I2C0MASK2;                  /*!< Offset: 0x038 (R/W)  I2C Slave address mask register 2 */
  __IO uint32_t I2C0MASK3;                  /*!< Offset: 0x03C (R/W)  I2C Slave address mask register 3 */
} LPC_I2C_TypeDef;
...
typedef struct
{
  __IO uint32_t WDMOD;                    /*!< Offset: 0x000 (R/W)  Watchdog mode Register */
  __IO uint32_t WDTC;                     /*!< Offset: 0x004 (R/W)  Watchdog timer constant Register */
  __O  uint32_t WDFEED;                   /*!< Offset: 0x008 ( /W)  Watchdog feed sequence Register */
  __I  uint32_t WDTV;                     /*!< Offset: 0x00C (R/ )  Watchdog timer value Register */
       uint32_t WDRESERVED0;
  __IO uint32_t WDWARNINT;				/*!< Offset: 0x014 (R/W)  Watchdog timer warning int. Register */
  __IO uint32_t WDWINDOW;					/*!< Offset: 0x018 (R/W)  Watchdog timer window value Register */
} LPC_WWDT_TypeDef;
...
typedef struct
{
  __IO uint32_t AD0CR;                     /*!< Offset: 0x000 (R/W)  A/D Control Register */
  __IO uint32_t AD0GDR;                    /*!< Offset: 0x004 (R/W)  A/D Global Data Register */
       uint32_t AD0RESERVED0[1];
  __IO uint32_t AD0INTEN;                  /*!< Offset: 0x00C (R/W)  A/D Interrupt Enable Register */
  __IO uint32_t AD0DR[8];                  /*!< Offset: 0x010 (R/W)  A/D Channel 0..7 Data Register */
  __I  uint32_t AD0STAT;                   /*!< Offset: 0x030 (R/ )  A/D Status Register */
} LPC_ADC_TypeDef;
...
typedef struct
{
  __I  uint32_t USBDevIntSt;               /*!< Offset: 0x000 (R/ )  USB Device Interrupt Status Register */
  __IO uint32_t USBDevIntEn;               /*!< Offset: 0x004 (R/W)  USB Device Interrupt Enable Register */
  __O  uint32_t USBDevIntClr;              /*!< Offset: 0x008 ( /W)  USB Device Interrupt Clear Register */
  __O  uint32_t USBDevIntSet;              /*!< Offset: 0x00C ( /W)  USB Device Interrupt Set Register */

  __O  uint32_t USBCmdCode;                /*!< Offset: 0x010 ( /W)  USB Command Code Register */
  __I  uint32_t USBCmdData;                /*!< Offset: 0x014 (R/ )  USB Command Data Register */

  __I  uint32_t USBRxData;                 /*!< Offset: 0x018 (R/ )  USB Receive Data Register */
  __O  uint32_t USBTxData;                 /*!< Offset: 0x01C ( /W)  USB Transmit Data Register */
  __I  uint32_t USBRxPLen;                 /*!< Offset: 0x020 (R/ )  USB Receive Packet Length Register */
  __O  uint32_t USBTxPLen;                 /*!< Offset: 0x024 ( /W)  USB Transmit Packet Length Register */
  __IO uint32_t USBCtrl;                   /*!< Offset: 0x028 (R/ )  USB Control Register */
  __O  uint32_t USBDevFIQSel;              /*!< Offset: 0x02C ( /W)  USB Device FIQ select Register */
} LPC_USB_TypeDef;
