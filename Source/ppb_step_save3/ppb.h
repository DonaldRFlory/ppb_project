...
#define TCRIT ((VELMAX - VELMIN) / ACCEL)
#define RAMP_IDLE  0
#define RAMP_UP    1
#define RAMP_LIM   2
#define RAMP_DOWN  3
...
typedef struct
{
    //RampTime is in up-ramp the time in seconds from start of move
    //and in down-ramp is the time in seconds from start of down-ramp
    //It is invalid and irrelevant in plateau phase if it exists
    float RampTime;
    U16 Infl1, Infl2;
    U16 StepCount;
