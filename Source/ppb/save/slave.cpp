...
U8 SlaveLinkProc(void)
{
	...
	switch(ArgCount)
	{
		...
		case 2:
			...
			{
			    case 0: /*void function*/
			        ((void (*)(UINT_T a1, UINT_T a2))(LDef.FunP) )(A1,A2);
			        SetExPhase(EX_RETURN, 0);
			        break;
...
//		return LinkCallStatus;
        ...
        U.X16[0] = GetServoUsec(A1);
        LRet(2);//pass back return value in union to packet handling
        //return  LE_NO_ERROR;
#endif
		return LinkCallStatus;
}
